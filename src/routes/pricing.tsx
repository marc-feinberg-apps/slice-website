...
export const Route = createFileRoute("/pricing")({
  head: () =>
    seo({
      ...
      path: "/pricing",
      description:
        "SLICE pricing: Free, Silver, Gold, and Platinum. Start free with settlement readiness, the calculator, what-if simulator, savings planner, monthly budget, creditor calls logging, and snowball timeline. Upgrade for AI negotiation, coaching, and done-with-you creditor calls.",
    }),
  component: Pricing,
});
...
const matrix: Row[] = [
  ...
  { label: "Monthly budget", free: true, silver: true, gold: true, platinum: true },
  { label: "Creditor calls logging & reminders", free: true, silver: true, gold: true, platinum: true },
  ...
  { label: "Juici AI Debt Coach", free: false, silver: true, gold: true, platinum: true },
